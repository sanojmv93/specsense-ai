"""
Minimal configuration file for the Spec Sense AI project.
...
PRODUCT_DATASET = PROJECT_ROOT / "data"/"product_catalog.csv"
USERS_DATASET = PROJECT_ROOT / "data"/"user_profile.csv"
